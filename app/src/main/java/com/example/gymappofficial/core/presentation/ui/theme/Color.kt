...
val DarkGray = Color(0xFF5E5B5B)
val MarronPesoActual = Color(0xff7A4444)
val fondoSubidaPeso = Color(0xff31AAAA)
val Comentario = Color(0xffC2AEAE)
val CursorBotones = Color(0xff9FFEF8)
val LightGray =  Color(0xFFCFC9C9)